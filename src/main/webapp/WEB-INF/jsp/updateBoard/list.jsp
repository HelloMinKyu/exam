...
<div class="wrap02">
  <form name="searchReq" id="searchReq" method="get" action="/uBoard/update/list/0">
  ...
  <div class="sub01_conts_wrap">
    <ul class="sub01_list">
      ...
      <li>
        <p>
          <span>(업데이트)</span>
          <a href="/uBoard/update/read/${Board.id}">${Board.title}</a>
        </p>
      </li>
      </c:forEach>
    </ul>
  ...
  <div class=" writing">
    ...
    <a href="/uBoard/update/create" class="w_btn">글쓰기</a>
    </c:if>
  </div>
  ...
  <div class="pageing">
    <ul>
      <li>
        <a href="/uBoard/update/list/${0 > pagingInfo.curPage - 1 ? 0 : pagingInfo.curPage - 1}${pathParam}">
...
<%--      </li>--%>
      ...
      <li>
        <div>
          ...
          href="/uBoard/update/list/${status.index}${pathParam}">${status.index + 1}
          </a>
        </div>
      </li>
      </c:forEach>
      <li>
        <a href="/uBoard/update/list/${pagingInfo.totalPage < pagingInfo.curPage + 1 ? pagingInfo.endPage : pagingInfo.curPage + 1}${pathParam}">
