...
<div class="wrap02">
  <div class="sub02">
    <p class="sub02_title" onclick="location.href='/nBoard/notice/list/0'" style="cursor : pointer">공지사항</p>
    ...
    <div class="sub02_conts">
      ...
      <div class="sub02_conts_btnwrap">
        <ul>
          ...
          <li><button class="edit_btn" onclick="location.href='/nBoard/notice/update/${board.id}'">수정</button></li>
    ...
    if(confirm("정말로 삭제하시겠습니까?")) {
      $.ajax({
        ...
        success: function (data) {
          alert("정상적으로 삭제되었습니다.")
          location.href='/nBoard/notice/list/0'
        },
        error: function () {
          alert("error");
        }
