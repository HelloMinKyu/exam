...
<div class="wrap02">
  <div class="sub02">
    <p class="sub02_title" style="cursor : pointer">내 문의함</p>
    ...
    <div class="sub02_conts">
      ...
      <div class="sub02_conts_btnwrap">
        <ul>
          <c:if test="${user.id eq board.account.id || user.gm eq 1}">
          <li><button class="edit_btn" onclick="location.href='/iBoard/inquiry/update/${board.id}'">수정</button></li>
